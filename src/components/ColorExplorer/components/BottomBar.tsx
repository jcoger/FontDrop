...
export function BottomBar({ label, children }: BottomBarProps) {
  return (
    <div className="h-14 w-full border-t border-border-default bg-surface-2 shrink-0 flex items-center px-6 justify-between relative z-20 shadow-[0_-4px_24px_rgba(0,0,0,0.3)]">
      {/* Left: method label */}
      <div className="w-[260px] flex items-center gap-2.5 shrink-0">
        <div className="w-2 h-2 rounded-full shadow-[0_0_6px_var(--accent-ring)]" style={{ backgroundColor: "var(--c-accent)" }} />
        <span
