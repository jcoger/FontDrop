  ...
  return (
    <div className="flex flex-col gap-5 items-center">
      ...
      <div
        ...
        onWheel={onWheel}
      >
        <div className="absolute inset-0 rounded-full" style={{ boxShadow: `0 0 24px 6px ${glowColor}40, 0 0 48px 12px ${glowColor}20`, transition: "box-shadow var(--dur-normal) ease" }} />
        <svg width={KNOB_SIZE} height={KNOB_SIZE} className="absolute inset-0">
          ...
          <circle cx={KNOB_R} cy={KNOB_R} r={TRACK_R} fill="none" stroke={glowColor} strokeWidth={3} strokeLinecap="round"
            ...
            style={{ transition: dragging.current ? "none" : "stroke var(--dur-normal) ease" }} />
        </svg>
        <div className="absolute rounded-full border border-border-strong" style={{ top: 12, left: 12, right: 12, bottom: 12, background: "radial-gradient(circle at 40% 35%, var(--surface-4), var(--surface-3))" }} />
      ...
      <div className="w-full">
        ...
        {/* Waveform display */}
        <div className="w-full h-12 rounded bg-surface-1 border border-border-default relative overflow-hidden mb-2">
          {(() => {
        ...
        {/* Smooth / Wild toggle */}
        <div className="flex rounded-md overflow-hidden border border-border-strong mb-3">
